                    ...
                    <div class="row g-4">
                        <div class="col-xl-3">
                            <div class="input-group w-100 mx-auto d-flex">
                                <input type="search" class="form-control p-3 searchCk" placeholder="keywords"
                                    aria-describedby="search-icon-1">
                                <span id="search-icon-1" class="input-group-text p-3 searchBtn"><i
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3 priceCk">
                                        ...
                                        <input type="range" class="form-range w-100" id="rangeInput" name="rangeInput"
                                            min="1000" max="10000" step="1000" value="10000"
                                            oninput="amount.value=rangeInput.value">
                                        <output id="amount" name="amount" min-value="1000" max-value="10000"
                                            for="rangeInput">10000</output>원 이하
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-3 brandCk">
                                        <h4>브랜드</h4>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="bCategories-1" name="Categories-1"
                                                value="Beverages" checked="checked">
                                            <label for="bCategories-1">전체</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="bCategories-2" name="Categories-1"
                                                value="Beverages">
                                            <label for="bCategories-2">허닭</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="bCategories-3" name="Categories-1"
                                                value="Beverages">
                                            <label for="bCategories-3">프레시지</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="bCategories-4" name="Categories-1"
                                                value="Beverages">
                                            <label for="bCategories-4">발재반점</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-3 typeCk">
                                        <h4>종류</h4>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="tCategories-1" name="Categories-2"
                                                value="Beverages">
                                            <label for="tCategories-1">전체</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="tCategories-2" name="Categories-2"
                                                value="Beverages">
                                            <label for="tCategories-2">닭가슴살</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="tCategories-3" name="Categories-2"
                                                value="Beverages">
                                            <label for="tCategories-3">스테이크/큐브</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="tCategories-4" name="Categories-2"
                                                value="Beverages">
                                            <label for="tCategories-4">소시지</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="tCategories-5" name="Categories-2"
                                                value="Beverages">
                                            <label for="tCategories-5">라이스</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="tCategories-6" name="Categories-2"
                                                value="Beverages">
                                            <label for="tCategories-6">만두/간식</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-9">
                            <div class="row g-4 justify-content-center product-item">
                                ...
                                <script>
                                    ...
                                    let rndEvnt = Math.floor(Math.random() * (4)) + 1; //1~5
                                    ...
                                    if (param1 != null) {
                                        ptype = '\'' + param1 + '\''
                                        showlist(null, ptype, price, keyword);
